  ...
  public: {
    Tables: {
      ...
      expense_entries: {
        ...
        Relationships: [
          {
            foreignKeyName: "expense_entries_purchase_order_id_fkey"
            columns: ["purchase_order_id"]
            isOneToOne: false
            referencedRelation: "purchase_orders"
            referencedColumns: ["id"]
      ...
      income_entries: {
        ...
        Relationships: [
          {
            foreignKeyName: "income_entries_sales_invoice_id_fkey"
      ...
      sales_invoice: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "sales_invoice_purchase_order_id_fkey"
            columns: ["purchase_order_id"]
            isOneToOne: false
            referencedRelation: "purchase_orders"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      increment_page_view: {
        Args:
          | { client_ip?: string; is_bot?: boolean; path: string }
          | { is_bot?: boolean; path: string }
        Returns: Json
      }
      is_admin: {
        Args: { user_id?: string }
